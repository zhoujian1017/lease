...
public class RoomInfoServiceImpl extends ServiceImpl<RoomInfoMapper, RoomInfo>
    ...
    public void saveOrUpdateRoom(RoomSubmitVo roomSubmitVo) {
        ...
        if(isUpdate){
            ...
            //4.删除原有roomLabelList
            LambdaQueryWrapper<RoomLabel> roomLabelLQueryWrapper = new LambdaQueryWrapper<>();
            roomLabelLQueryWrapper.eq(RoomLabel::getRoomId,roomSubmitVo.getId());
            roomLabelService.remove(roomLabelLQueryWrapper);
